...
class MyWidget extends StatefulWidget{
  ...
  const MyWidget(this.liste,this.selectedTextCallBack, this.selectedTextIndexCallBack,this.selectedTextEnglishCallBack,{super.key});
          ...
          children: List.generate(10,(index){
            return InkWell(
              ...
              onTap: widget.liste[index].enable?() {
                ...
                widget.selectedTextEnglishCallBack(widget.liste[index].isEnglish);
